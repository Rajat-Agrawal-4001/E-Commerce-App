<div data-enable-ad="true" data-ad-type="footer"></div>
        ...
        <div class="footer-inner">
            <div class="row">
                <div class="col-xl-3 col-md-6 col-sm-6 box-widget-col">
                    <div class="footer-widget footer-box-widget">
                        <div class="logo"><img src="<?= htmlspecialchars($site_row['site_logo']); ?>" alt="umart-logo" height="50px" width="50px"></div>

                        <p>Solid is the information & experience
                            directed at an end-user</p>
                        <div class="quick-contact">
                            <div class="phone contact-item">
                                <div class="icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="40px" height="40px">
                                        <defs>
                                            <filter id="Filter_0">
                                ...
                                <div class="contact-info">
                                    ...
                                    <a href="tel:0020500" class="service-time info"><?= htmlspecialchars($site_row['phone_number']); ?> - CALL - <?= htmlspecialchars($site_row['phone_number']); ?></a>
                                </div>
                            </div>
                            <div class="email contact-item">
                                ...
                                <div class="contact-info">
                                    ...
                                    <a href="mailto:<?= htmlspecialchars($site_row['contact_email']); ?>" class="email-address info"><?= htmlspecialchars($site_row['contact_email']); ?></a>
                                </div>
                            </div>
                        </div>
                        <ul class="social-links-footer2">
                            <li><a class="platform fb" target="_blank" href="<?= htmlspecialchars($site_row['fb_link']); ?>"><i class="fab fa-facebook"></i></a>
                            </li>
                            <li><a class="platform yt" target="_blank" href="<?= htmlspecialchars($site_row['youtube_link']); ?>"><i class="fab fa-youtube"></i></a>
                            </li>
                            <li><a class="platform ttr" target="_blank" href="<?= htmlspecialchars($site_row['twitter_link']); ?>"><i class="fab fa-twitter"></i></a>
                            </li>
                            <li><a class="platform lkd" target="_blank" href="<?= htmlspecialchars($site_row['linkedin_link']); ?>"><i class="fab fa-linkedin"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-sm-6 box-widget-col2">
                    <div class="footer-widget">
                        ...
                        <p class="widget-text"><?= decoder($site_row['about_site']); ?></p>
                ...
                <div class="col-lg-13 col-md-6 col-sm-6 no-gutters">
                    <div class="footer-widget">
                        ...
                        <ul class="widget-items cata-widget">
                            ...
                            <li class="widget-list-item"><a href="wishlist.php">Wishlist</a></li>
                            <li class="widget-list-item"><a href="cart.php">Cart</a></li>
                ...
                <div class="col-lg-13 col-md-6 col-sm-6 no-gutters">
                    ...
                    <ul class="footer-widget">
                        ...
                        <li class="widget-list-item"><a href="shop_affiliate.php">Shop</a></li>
                    </ul>
                </div>
                <div class="col-lg-25 col-md-6 col-sm-6">
                    ...
                    <div class="footer-widget newsletter-widget">
                        ...
                        <div class="input-div">
                            <input type="email" name="s_email" id="s_email" placeholder="Enter email address">
                        </div>
                        <a href="#0" class="subscribe-btn" id="s_btn">Subscribe Now <i class="fal fa-long-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="footer-bottombar">
                <div class="app-download">
                    ...
                    <a href="http://appstore.com/" target="_blank" class="download-store"><img src="assets/images/items/appstore.jpg" alt=""></a>
                    <a href="https://play.google.com/store/apps" target="_blank" class="download-store"><img src="assets/images/items/playstore.jpg" alt=""></a>
                </div>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="footer-bottom-inner">
                <span class="copyright">Copyright & Design By <a href="http://reacthemes.com/" class="brand" target="_blank">Reacthemes</a> -2022</span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="newsletter-inner">
        ...
        <form>
            <div class="input-area">
                ...
                <div class="input-div"><input type="email" name="s_email2" id="s_email2" placeholder="Email address">
                    <div class="input-icon"><i class="far fa-envelope"></i></div>
                </div>
            </div>
            <button type="button" class="subscribe-btn" id="s_btn2">Subscribe Now <i class="fal fa-long-arrow-right ml--5"></i></button>
        </form>
    </div>
</div>
...
<script>
    ...
    $("#s_btn2").on("click", function(e) {

        let email = $('#s_email2').val();
    ...
    $("#s_btn3").on("click", function(e) {

let email = $('#s_email3').val();
