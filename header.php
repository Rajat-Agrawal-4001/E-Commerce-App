<div data-enable-ad="true" data-ad-type="header" style="max-height: 200px; max-width:500px;"></div>
<header id="rtsHeader">
        ...
        <div class="container">
            <div class="navbar-part navbar-part2">
                <div class="navbar-inner">
                    <div class="left-side">
                        <a href="index.html" class="logo"><img src="<?= htmlspecialchars($site_row['site_logo']); ?>" alt="umart-logo" height="60px" width="60px"></a>
                        <div class="navbar-input-inner">
                            <form action="shop.php" id="search_form" method="post">
                                <div class="input-div">
                                    <button type="submit" class="search-input-icon"><i class="rt-search mr--10"></i></button>
                                    <input class="search-input" type="text" name="keyword" id="keyword" placeholder="Search Keyword...">
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="header-action-items header-action-items1">
                        <ul>
                            ...
                            ?>
                                      <a href="shop?cat=<?php echo $cat; ?>"><li><?= $cat; ?></li></a>
                                <?php }
                            } else {
                                ?>
                                <li><a href="#">Man</a></li>
                        ...
                        <div class="cart action-item">
                            <div class="cart-nav">
                                <div class="cart-icon icon"><a href="#0"><i aria-hidden="true" class="fas fa-shopping-basket"></i></a><span class="wishlist-dot icon-dot" id="dots"><?= getCartItems('5', 'CART'); ?></span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="rts-menu">
                        <nav class="menus menu-toggle">
                            <ul class="nav__menu">
                                ...
                                <li><a class="menu-item" href="news">Blogs</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="hamburger-1">
...
*/
    ...
    ?>
        ...
        <div class="cart-bottom-area">
            ...
            <span class="total-price">TOTAL: <span class="price" id="grandTotal"><?php echo round($total_mrp - $total_discount, 2); ?></span></span>
    ...
    <aside class="slide-bar">
        ...
        <nav class="side-mobile-menu side-mobile-menu1">
            <ul id="mobile-menu-active">
                <li class="has-dropdown firstlvl">
                    <a class="mm-link" href="index">Home <i class="rt-angle-down"></i></a>
                </li>
                <li class="has-dropdown firstlvl">
                    <a class="mm-link" href="shop">Shop <i class="rt-angle-down"></i></a>
                </li>
                <li class="has-dropdown firstlvl">
                    <a class="mm-link" href="about">About us <i class="rt-angle-down"></i></a>
                </li>
                <li class="has-dropdown firstlvl">
                    <a class="mm-link" href="news">Blogs <i class="rt-angle-down"></i></a>
                </li>
                <li><a class="mm-link" href="contact">Contact</a></li>
            </ul>
        </nav>
        <div class="header-action-items header-action-items1 header-action-items-side">
            ...
            <div class="cart action-item">
                <div class="cart-nav">
                    <div class="cart-icon icon"><i class="rt-cart"></i><span class="wishlist-dot icon-dot">0</span>
                    </div>
                </div>
            </div>
