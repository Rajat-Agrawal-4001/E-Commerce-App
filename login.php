...
if (isset($_POST['name'], $_POST['pass'])) {
    ...
    $sql = "select * from vendor where name='$name' and password='$pass'";
...
<!-- /login.html / [XR&CO'2014],  19:55:22 GMT -->
                        ...
                        <div class="rts-menu">
                            <nav class="menus menu-toggle">
                                <ul class="nav__menu">
                                    ...
                                    <li class="has-dropdown"><a class="menu-item active1" href="#">Pages <i
                                        class="rt-plus"></i></a>
                                        <ul class="dropdown-ul">
                ...
                <ul id="mobile-menu-active">
                    ...
                    <li class="has-dropdown firstlvl">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="thank-you.html">Search Result</a></li>
                        </ul>
                    </li>
                    <li class="has-dropdown firstlvl">
                            ...
                            <form action="#" id="login_form" method="post">
                                    <div class="form">
                                        <input type="text" class="form-control" id="username"
                                            placeholder="Username or email address*" name="name" />
                                    </div>
                                    <div class="form">
        ...
        $('#login').click(function(e) {
            $.ajax({
                ...
                success: function(html) {
                    if (html == 'Login Failed.'){
                        Swal.fire(html, "Invalid Details.", "error");
                    }
                    else{
                        Swal.fire(html, "", "success");
                    }         
                }
            });
...
<!-- /login.html / [XR&CO'2014],  19:55:23 GMT -->
</html>